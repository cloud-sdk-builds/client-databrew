...
[`@aws-sdk/client-databrew`](https://www.npmjs.com/package/@aws-sdk/client-databrew/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-databrew@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B0Ux9oPOhWVLAChlpwHYof98A0rugt35nvVe7Y1mfc4vtTmeg0CfRa/ESOrrs7SI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-databrew": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-databrew@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-databrew@3.52.0/index.min.mjs": "sha384-B0Ux9oPOhWVLAChlpwHYof98A0rugt35nvVe7Y1mfc4vtTmeg0CfRa/ESOrrs7SI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-databrew/blob/refs/tags/3.52.0/LICENSE
```
